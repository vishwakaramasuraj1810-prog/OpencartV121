...
public class ExcelUtility {
	...
	public String getCellData(String sheetName,int rownum,int colnum) throws Exception
	{
		...
		try
		{
			...
			data=formatter.formatCellValue(cell);    //Returns the formated value of a cell as a string regardless of a cell type.
		}
		catch(Exception e)
		{
			data="";
	...
	public void setCellData(String sheetName,int rownum,int colnum,String data) throws Exception
	{
		...
		if(workbook.getSheetIndex(sheetName)==1)     //if sheet is not exists the create
		{
